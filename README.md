...
|---|---|---|---|---|
| [`crates/pq-l2`](crates/pq-l2) | landed | `lance-linalg::distance::l2`, PQ probe | PQ L2 distance: distance_table + per-vector distances | **+11.9% speedup vs upstream**, paired CI [+11.4%, +12.4%] (M1 Max, aarch64; bit-equivalent output; x86 untested; see experiments/pq-l2-may25) |
